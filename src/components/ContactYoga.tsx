...
export default function ContactYoga() {
    ...
    return (
        <section id="contactYoga" className="relative">
            <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <form
                    ...
                    <p className="leading-relaxed mb-5">
                        Plusieurs manières de me contacter, le sms reste la façon la plus efficace de m'avoir.
                    </p>
